...
/*package*/ class MeasurementType2UnitMapping_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public MeasurementType2UnitMapping_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_n8rvfz_a");
  ...
  private EditorCell createRefCell_0() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, LINKS.type$Tnax, CONCEPTS.Measurement$IE, "type", getEditorContext()) {
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.type$Tnax);
    }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_n8rvfz_b0");
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.unit$TmGv;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
