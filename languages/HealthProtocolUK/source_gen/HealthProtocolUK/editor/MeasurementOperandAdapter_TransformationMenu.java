...
public class MeasurementOperandAdapter_TransformationMenu extends TransformationMenuBase {
  ...
  public List<TransformationMenuItem> createMenuItems(@NotNull TransformationMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default transformation menu for " + "MeasurementOperandAdapter", new SNodePointer("r:12896a7d-0e31-4fe4-9e9c-c4260ead99f1(HealthProtocolUK.editor)", "1314835973984448074")));
    try {
  ...
  public class TMP_IncludeSM_6lyiwy_a0 extends IncludeSubstituteMenuTransformationMenuPart {
    ...
    public List<TransformationMenuItem> createItems(@NotNull TransformationMenuContext context) {
      ...
      try {
        ...
        context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("include substitute menu for the link target concept: " + name, new SNodePointer("r:12896a7d-0e31-4fe4-9e9c-c4260ead99f1(HealthProtocolUK.editor)", "1314835973984448088")));
